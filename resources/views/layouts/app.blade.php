...
<h3 class="text-white my-2 my-sm-0 text-sm-right" style=""><small>Bienvenido {{ $sesion->usuario }}</small></h3>
		...
		<div class="dropdown show">
		  <a class="mr-5" href="" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #1976D2">
			...
			<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
				...
				<a class="dropdown-item" href="{{ route('cerrarsesion_path') }}">Cerrar Sesion</a>
			</div>
		</div>
	</ul>
</header>
